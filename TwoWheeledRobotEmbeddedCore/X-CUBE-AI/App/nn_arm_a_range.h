...
#ifndef AI_NN_ARM_A_RANGE_H
#define AI_NN_ARM_A_RANGE_H
#pragma once

#include "nn_arm_a_range_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NN_ARM_A_RANGE_MODEL_NAME          "nn_arm_a_range"
#define AI_NN_ARM_A_RANGE_ORIGIN_MODEL_NAME   "policy_arm_b_range"

/******************************************************************************/
#define AI_NN_ARM_A_RANGE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NN_ARM_A_RANGE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NN_ARM_A_RANGE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NN_ARM_A_RANGE_IN_NUM        (1)

AI_DEPRECATED
#define AI_NN_ARM_A_RANGE_IN \
  ai_nn_arm_a_range_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NN_ARM_A_RANGE_IN_SIZE { \
  AI_NN_ARM_A_RANGE_IN_1_SIZE, \
}
#define AI_NN_ARM_A_RANGE_IN_SIZE_BYTES { \
  AI_NN_ARM_A_RANGE_IN_1_SIZE_BYTES, \
}
#define AI_NN_ARM_A_RANGE_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NN_ARM_A_RANGE_IN_1_CHANNEL     (13)
#define AI_NN_ARM_A_RANGE_IN_1_SIZE        (13)
#define AI_NN_ARM_A_RANGE_IN_1_SIZE_BYTES  (52)

/******************************************************************************/
#define AI_NN_ARM_A_RANGE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NN_ARM_A_RANGE_OUT \
  ai_nn_arm_a_range_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NN_ARM_A_RANGE_OUT_SIZE { \
  AI_NN_ARM_A_RANGE_OUT_1_SIZE, \
}
#define AI_NN_ARM_A_RANGE_OUT_SIZE_BYTES { \
  AI_NN_ARM_A_RANGE_OUT_1_SIZE_BYTES, \
}
#define AI_NN_ARM_A_RANGE_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NN_ARM_A_RANGE_OUT_1_CHANNEL     (2)
#define AI_NN_ARM_A_RANGE_OUT_1_SIZE        (2)
#define AI_NN_ARM_A_RANGE_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_NN_ARM_A_RANGE_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup nn_arm_a_range
 ...
 * @ref ai_nn_arm_a_range_create. Both the activations memory buffer 
 ...
 * using @ref ai_nn_arm_a_range_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_nn_arm_a_range_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_nn_arm_a_range_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NN_ARM_A_RANGE_*
 * defines into file @ref nn_arm_a_range.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_nn_arm_a_range_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NN_ARM_A_RANGE_H */
