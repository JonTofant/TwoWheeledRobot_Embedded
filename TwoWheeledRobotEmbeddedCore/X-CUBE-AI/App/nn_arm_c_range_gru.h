...
#ifndef AI_NN_ARM_C_RANGE_GRU_H
#define AI_NN_ARM_C_RANGE_GRU_H
#pragma once

#include "nn_arm_c_range_gru_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NN_ARM_C_RANGE_GRU_MODEL_NAME          "nn_arm_c_range_gru"
#define AI_NN_ARM_C_RANGE_GRU_ORIGIN_MODEL_NAME   "policy_arm_c_range_gru_stm32ai"

/******************************************************************************/
#define AI_NN_ARM_C_RANGE_GRU_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NN_ARM_C_RANGE_GRU_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NN_ARM_C_RANGE_GRU_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NN_ARM_C_RANGE_GRU_IN_NUM        (2)

AI_DEPRECATED
#define AI_NN_ARM_C_RANGE_GRU_IN \
  ai_nn_arm_c_range_gru_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NN_ARM_C_RANGE_GRU_IN_SIZE { \
  AI_NN_ARM_C_RANGE_GRU_IN_1_SIZE, \
  AI_NN_ARM_C_RANGE_GRU_IN_2_SIZE, \
}
#define AI_NN_ARM_C_RANGE_GRU_IN_SIZE_BYTES { \
  AI_NN_ARM_C_RANGE_GRU_IN_1_SIZE_BYTES, \
  AI_NN_ARM_C_RANGE_GRU_IN_2_SIZE_BYTES, \
}
#define AI_NN_ARM_C_RANGE_GRU_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NN_ARM_C_RANGE_GRU_IN_1_CHANNEL     (13)
#define AI_NN_ARM_C_RANGE_GRU_IN_1_SIZE        (13)
#define AI_NN_ARM_C_RANGE_GRU_IN_1_SIZE_BYTES  (52)
#define AI_NN_ARM_C_RANGE_GRU_IN_2_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NN_ARM_C_RANGE_GRU_IN_2_CHANNEL     (64)
#define AI_NN_ARM_C_RANGE_GRU_IN_2_SIZE        (64)
#define AI_NN_ARM_C_RANGE_GRU_IN_2_SIZE_BYTES  (256)

/******************************************************************************/
#define AI_NN_ARM_C_RANGE_GRU_OUT_NUM       (2)

AI_DEPRECATED
#define AI_NN_ARM_C_RANGE_GRU_OUT \
  ai_nn_arm_c_range_gru_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NN_ARM_C_RANGE_GRU_OUT_SIZE { \
  AI_NN_ARM_C_RANGE_GRU_OUT_1_SIZE, \
  AI_NN_ARM_C_RANGE_GRU_OUT_2_SIZE, \
}
#define AI_NN_ARM_C_RANGE_GRU_OUT_SIZE_BYTES { \
  AI_NN_ARM_C_RANGE_GRU_OUT_1_SIZE_BYTES, \
  AI_NN_ARM_C_RANGE_GRU_OUT_2_SIZE_BYTES, \
}
#define AI_NN_ARM_C_RANGE_GRU_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NN_ARM_C_RANGE_GRU_OUT_1_CHANNEL     (2)
#define AI_NN_ARM_C_RANGE_GRU_OUT_1_SIZE        (2)
#define AI_NN_ARM_C_RANGE_GRU_OUT_1_SIZE_BYTES  (8)
#define AI_NN_ARM_C_RANGE_GRU_OUT_2_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NN_ARM_C_RANGE_GRU_OUT_2_CHANNEL     (64)
#define AI_NN_ARM_C_RANGE_GRU_OUT_2_SIZE        (64)
#define AI_NN_ARM_C_RANGE_GRU_OUT_2_SIZE_BYTES  (256)

/******************************************************************************/
#define AI_NN_ARM_C_RANGE_GRU_N_NODES (24)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup nn_arm_c_range_gru
 ...
 * @ref ai_nn_arm_c_range_gru_create. Both the activations memory buffer 
 ...
 * using @ref ai_nn_arm_c_range_gru_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_nn_arm_c_range_gru_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_nn_arm_c_range_gru_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NN_ARM_C_RANGE_GRU_*
 * defines into file @ref nn_arm_c_range_gru.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_nn_arm_c_range_gru_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NN_ARM_C_RANGE_GRU_H */
