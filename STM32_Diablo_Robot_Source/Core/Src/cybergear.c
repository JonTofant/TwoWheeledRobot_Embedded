...
CyberGear CyberGearMotorList[MAX_MOTORS] = {
    { .hostID = 0xFE, .motorID = 0x52, .angle = 1.0f, .min_angle = leftBackMinAngle, .max_angle = leftBackMaxAngle,
    ...
    { .hostID = 0xFE, .motorID = 0x51, .angle = 1.0f, .min_angle = leftFrontMinAngle, .max_angle = leftFrontMaxAngle,
      .kp = 3.0f, .kd = 0.5f, .errorFlag = true,.max_velocity = 30.0f, .update_flag = false, .target_current_LQR = 0.0f, .desired_angle = 0.0f, .desired_velocity = 0.0f, .desired_torque_ff = 0.0f },
    { .hostID = 0xFE, .motorID = 0x53, .angle = 1.0f, .min_angle = ANGLE_MIN, .max_angle = ANGLE_MAX,
      .kp = 3.0f, .kd = 0.5f, .errorFlag = true ,.max_velocity = 30.0f, .update_flag = false, .target_current_LQR = 0.0f, .desired_angle = 0.0f, .desired_velocity = 0.0f, .desired_torque_ff = 0.0f },
