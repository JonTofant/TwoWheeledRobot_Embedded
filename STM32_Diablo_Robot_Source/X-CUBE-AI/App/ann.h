...
/******************************************************************************/
#define AI_ANN_MODEL_NAME          "ann"
#define AI_ANN_ORIGIN_MODEL_NAME   "policy"

/******************************************************************************/
#define AI_ANN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ANN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ANN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ANN_IN_NUM        (1)

AI_DEPRECATED
#define AI_ANN_IN \
  ai_ann_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ANN_IN_SIZE { \
  AI_ANN_IN_1_SIZE, \
}
#define AI_ANN_IN_SIZE_BYTES { \
  AI_ANN_IN_1_SIZE_BYTES, \
}
#define AI_ANN_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_ANN_IN_1_CHANNEL     (9)
#define AI_ANN_IN_1_SIZE        (9)
#define AI_ANN_IN_1_SIZE_BYTES  (36)

/******************************************************************************/
#define AI_ANN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ANN_OUT \
  ai_ann_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ANN_OUT_SIZE { \
  AI_ANN_OUT_1_SIZE, \
}
#define AI_ANN_OUT_SIZE_BYTES { \
  AI_ANN_OUT_1_SIZE_BYTES, \
}
#define AI_ANN_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_ANN_OUT_1_HEIGHT      (1)
#define AI_ANN_OUT_1_CHANNEL     (2)
#define AI_ANN_OUT_1_SIZE        (1 * 2)
#define AI_ANN_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_ANN_N_NODES (7)
 ...
 * @ref ai_ann_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_ANN_*
 * defines into file @ref ann.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
